...
const data = [
  {
    ...
    labelId: 'overview',
    descriptionid: 'overview_description',
    to: '/dashboard/overview',
  },
  {
    icon: <IconDroplet />,
    labelId: 'water',
    descriptionid: 'water_description',
    to: '/dashboard/water',
  },
  {
    icon: <IconRun />,
    labelId: 'activity',
    descriptionid: 'activity_description',
    to: '/dashboard/activity',
  },
  {
    icon: <IconBed />,
    labelId: 'sleep',
    descriptionid: 'sleep_description',
    to: '/dashboard/sleep',
  },
  {
    icon: <IconCategory />,
    labelId: 'custom_category',
    descriptionid: 'custom_category_description',
    to: '/dashboard/custom',
  },
];
